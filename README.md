...
Methods read the value of the header from the `$_SERVER` superglobal. Alternatively a string containing a header can be supplied as an argument. Methods will return `false` if the request header is not present or cannot be parsed.
